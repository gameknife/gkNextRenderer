...
set(_repo_vulkan_sdk_root "${CMAKE_SOURCE_DIR}/external/VulkanSDK")
set(_repo_vulkan_sdk_current "${_repo_vulkan_sdk_root}/.current_version")
if(EXISTS "${_repo_vulkan_sdk_current}")
    file(STRINGS "${_repo_vulkan_sdk_current}" _repo_vulkan_sdk_version LIMIT_COUNT 1)
    if(_repo_vulkan_sdk_version)
        list(APPEND _slang_hint_dirs "${_repo_vulkan_sdk_root}/${_repo_vulkan_sdk_version}")
    endif()
endif()
if(EXISTS "${_repo_vulkan_sdk_root}")
    file(GLOB _repo_vulkan_sdk_candidates LIST_DIRECTORIES true "${_repo_vulkan_sdk_root}/*")
    list(SORT _repo_vulkan_sdk_candidates)
    list(REVERSE _repo_vulkan_sdk_candidates)
    foreach(_repo_vulkan_sdk_candidate IN LISTS _repo_vulkan_sdk_candidates)
        if(IS_DIRECTORY "${_repo_vulkan_sdk_candidate}")
            list(APPEND _slang_hint_dirs "${_repo_vulkan_sdk_candidate}")
        endif()
    endforeach()
endif()
