...
vcpkg_replace_string("${SOURCE_PATH}/Build/CMakeLists.txt"
    [[set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -ffp-model=precise")]]
    [[include(CheckCXXCompilerFlag)
		check_cxx_compiler_flag("-ffp-model=precise" JPH_SUPPORTS_FFP_MODEL_PRECISE)
		if (JPH_SUPPORTS_FFP_MODEL_PRECISE)
			set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -ffp-model=precise")
		endif()]]
)
