...
namespace Vulkan::PipelineCommon
{
                                           ...
                                           const Assets::Scene& scene): swapChain_(swapChain)
    {
        ...
        {
            VkDescriptorImageInfo Info1 = {NULL, sourceImageView.Handle(), VK_IMAGE_LAYOUT_GENERAL};
        	VkDescriptorImageInfo Info2 = {NULL, prevImageView.Handle(), VK_IMAGE_LAYOUT_GENERAL};
        	VkDescriptorImageInfo Info3 = {NULL, targetImageView.Handle(), VK_IMAGE_LAYOUT_GENERAL};
