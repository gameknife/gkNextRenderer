...
namespace KongLie3D
{
                    ...
                    std::vector<std::shared_ptr<Assets::Node>>& nodes)
    {
        ...
        const uint32_t enemyLightCellMaterialId = Assets::SceneBuilder::AddLambertianMaterial(materials, glm::vec3(0.40f, 0.34f, 0.48f));
        const uint32_t enemyDarkCellMaterialId = Assets::SceneBuilder::AddLambertianMaterial(materials, glm::vec3(0.24f, 0.20f, 0.34f));
        const uint32_t playerLightCellMaterialId = Assets::SceneBuilder::AddLambertianMaterial(materials, glm::vec3(0.58f, 0.56f, 0.54f));
        const uint32_t playerDarkCellMaterialId = Assets::SceneBuilder::AddLambertianMaterial(materials, glm::vec3(0.33f, 0.32f, 0.31f));
        const uint32_t midlineMaterialId = Assets::SceneBuilder::AddLambertianMaterial(materials, glm::vec3(0.32f, 0.82f, 1.0f));
        const uint32_t borderMaterialId = Assets::SceneBuilder::AddLambertianMaterial(materials, glm::vec3(0.18f, 0.19f, 0.22f));
        const uint32_t baseMaterialId = Assets::SceneBuilder::AddLambertianMaterial(materials, glm::vec3(0.12f, 0.13f, 0.16f));
        const uint32_t benchPlatformMaterialId = Assets::SceneBuilder::AddLambertianMaterial(materials, glm::vec3(0.22f, 0.23f, 0.28f));

        nodes.push_back(Assets::SceneBuilder::CreateRenderNode("BoardBase",
        ...
        nodes.push_back(Assets::SceneBuilder::CreateRenderNode("BenchPlatform",
        ...
        nodes.push_back(Assets::SceneBuilder::CreateRenderNode("BoardBorder_West",
                                                       glm::vec3(-0.60f, 0.0f, 3.5f),
                                                       glm::vec3(1.0f),
                                                       static_cast<uint32_t>(nodes.size()),
                                                       borderLongModelId,
                                                       borderMaterialId));
        nodes.push_back(Assets::SceneBuilder::CreateRenderNode("BoardBorder_East",
                                                       glm::vec3(6.60f, 0.0f, 3.5f),
                                                       glm::vec3(1.0f),
                                                       static_cast<uint32_t>(nodes.size()),
                                                       borderLongModelId,
                                                       borderMaterialId));
        nodes.push_back(Assets::SceneBuilder::CreateRenderNode("BoardBorder_North",
                                                       glm::vec3(3.0f, 0.0f, -0.60f),
                                                       glm::vec3(1.0f),
                                                       static_cast<uint32_t>(nodes.size()),
                                                       borderWideModelId,
                                                       borderMaterialId));
        nodes.push_back(Assets::SceneBuilder::CreateRenderNode("BoardBorder_South",
