...
#include "Modules/NextCapture/ScreenShotExport.hpp"
...
namespace Runtime
{
    ...
    bool FScreenShotService::IsGifEncodingAvailable() const
    {
    ...
    void FScreenShotService::SaveSwapChainToFile(
        ...
        const int width,
        const int height,
        const ScreenShot::EFileFormat fileFormat,
        const bool synchronous,
        std::function<void()> onCompleted,
        std::function<void()> onReadbackCompleted)
    {
        ScreenShot::SaveSwapChainToFile(
            renderer,
