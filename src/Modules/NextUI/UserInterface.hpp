...
#include "Modules/NextUI/UiTextureResolver.hpp"
#include <imgui.h>
...
class UserInterface final : public IUserInterface
{
public:
    ...
    Runtime::Config::UserSettings& Settings() override { return userSettings_; }
    ...
    ImTextureID RequestImTextureIdRaw(uint32_t bindlessSampleSlot) override
    {
        return EncodeBindlessTextureId(bindlessSampleSlot);
    }
    ...
    ImFont* GetTitleBarFont() const override { return titleBarFont_; }
