...
namespace Vulkan
{
	...
	public:
		...
		DeviceMemory(const Device& device, size_t size, bool external, uint32_t memoryTypeBits, VkMemoryAllocateFlags allocateFLags, VkMemoryPropertyFlags propertyFlags);
