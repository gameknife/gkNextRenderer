...
namespace Assets
{
    ...
    {
    public:
        static Camera AutoFocusCamera(Assets::EnvironmentSetting& cameraInit, std::vector<std::shared_ptr<Assets::Node>>& nodes, std::vector<Model>& models, bool obliqueView = false);
