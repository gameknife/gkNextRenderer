...
namespace Vulkan
{
    ...
    FActiveRenderViewScope::FActiveRenderViewScope(VulkanBaseRenderer& renderer, RenderView& view)
        : renderer_(renderer)
        , previousContext_(renderer.activeViewContext_)
    {
        renderer_.activeViewContext_ = {
            .view = &view,
            .sceneOverride = view.SceneOverride(),
            .bankBase = view.RtBankBase(),
            .renderExtent = view.RenderExtent(),
            .cameraAddress = view.CameraAddress(),
            .visibilityFramebuffer = view.VisibilityFramebuffer(),
        };
    }

    FActiveRenderViewScope::~FActiveRenderViewScope()
    {
        renderer_.activeViewContext_ = previousContext_;
    }
}
