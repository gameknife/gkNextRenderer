...
namespace NextCVar
{
    void RegisterEngineCVars(FCVarSystem& cvars, Runtime::Config::UserSettings& settings, Runtime::Config::ShowFlags& showFlags, NextEngine* engine)
    {
        ...
        GK_CVAR_BOOL("r.atmosphere.enable", settings, AtmosphereEnable, false, ECVarFlags::Archive, "Enable procedural sky atmosphere");
        GK_CVAR_BOOL("r.atmosphere.aerialPerspective", settings, AtmosphereAerialPerspective, false, ECVarFlags::Archive, "Enable aerial perspective");
        GK_CVAR_BOOL("r.atmosphere.heightFog", settings, AtmosphereHeightFog, false, ECVarFlags::Archive, "Enable exponential height fog");
        ...
        GK_CVAR_FLOAT_RANGE("r.upscaler.fireflySigma", settings, TemporalUpscalerFireflySigma, 0.5f, ECVarFlags::Archive, "Temporal upscaler and compose isolated highlight rejection threshold in neighborhood standard deviations", 0.1, 8.0);
        ...
        GK_CVAR_BOOL("show.debugAreaLights", showFlags, DebugDraw_AreaLights, false, ECVarFlags::None, "Debug draw scene finite and point lights");
