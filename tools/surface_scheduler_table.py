"""Render the Shading Scheduler A/B table from a surface-scheduler agent-validation report.

Usage:
    python3 tools/surface_scheduler_table.py out/build/windows/agent_reports/surface-scheduler-1080p.json
"""
...
TIMERS = ["surface build", "shading classify", "shadingpass", "gtao pass",
          "checkerboard resolve", "simplecompose pass"]
...
def main(path):
    ...
    header = ["config"] + TIMERS + ["frame total", "fps"]
    rows = []
