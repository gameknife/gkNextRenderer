...
CLI overview: [`docs/guides/gnb-cli.md`](../../docs/guides/gnb-cli.md)

Source-level architecture guide (for editing `gnb` itself): [`docs/guides/gnb-architecture.md`](../../docs/guides/gnb-architecture.md)
